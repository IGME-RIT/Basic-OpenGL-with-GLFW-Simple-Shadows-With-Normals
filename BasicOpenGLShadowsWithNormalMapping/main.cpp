...
#pragma region Shadow_Asset_loading
	...
	shadowMat->SetTexture((char*)"normalMap", new Texture((char*)"Assets/BrickNormal.png"));
	#pragma endregion
	...
	#pragma region Updates
		...
		glm::mat4 lightProjection = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 0.01f, 10.f);
